...
resource "aws_key_pair" "example" {
  key_name   = "newkey_x"  # Replace with your desired key name
  public_key = file("C:/Users/Kisho/.ssh/id_rsa.pub") 
...
resource "aws_instance" "server" {
  ...
  connection {
   ...
   private_key = file("C:/Users/Kisho/.ssh/id_rsa")
 ...
 provisioner "local-exec" {
  ...
  #ssh -i "new_key_us1.pem" ec2-user@44.203.30.225
  }
